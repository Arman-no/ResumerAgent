  ...
  for (const dirName of projectDirs) {
    ...
    for (const file of files) {
      ...
      sessions.push({
        ...
        // Windows and macOS report a real creation time. Several Linux
        // filesystems report 0 instead, which would sort every session as
        // 1970, so fall back to mtime there.
