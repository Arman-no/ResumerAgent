...
// Real first lines observed on this machine are ~100-125 bytes, so this
// has a wide margin — but it's a hard cutoff: if cwd ever appears past
// this many bytes into a file, that session is silently dropped rather
// than degrading to a slower full-file scan.
